...
import { Fieldset } from "../../../../sylica/src/components/fieldset"; // Ensure the path is correct
import "../../../../sylica/src/components/fieldset/CustomFieldset.css"; // Import any custom styles if needed
